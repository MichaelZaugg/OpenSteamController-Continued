...
echo ""
echo "Next steps:"
echo "1. Eject the USB Mass Storage device"
echo "2. Power cycle your LPC11U37 device (disconnect and reconnect power)"
echo "3. The device should NOT appear as USB Mass Storage anymore"
echo ""
print_warning "If the device still appears as USB Mass Storage after power cycle:"
echo "  - Check that Right Trigger is not pulled, or the ISP pin is not pulled low"
